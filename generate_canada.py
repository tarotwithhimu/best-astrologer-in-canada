...
# -*- coding: utf-8 -*-
"""
Generates the Canada build of the Himu astrology site:
  - index.html
...
NAV_CITIES = ["toronto", "vancouver", "montreal", "calgary", "ottawa", "edmonton"]
    ...
    <div class="container nav-container">
        <div class="logo">
            <a href="index.html" style="text-decoration:none;">
                <p class="logo-title">{LOGO_MARK}Best Astrologer in Canada</p>
            </a>
...
def footer():
    a = NAV_CITIES[:3]
    b = NAV_CITIES[3:] + ["winnipeg", "halifax", "victoria"]
    city_links_a = "\n".join(
    ...
    <div class="container">
        <div class="footer-grid">
            <div>
                <h4>Best Astrologer — Online for Canada</h4>
                <p class="footer-blurb">Himu — Vedic Astrology, Tarot, Numerology &amp; Vastu, available online for clients across Canada.</p>
                <ul>
...
{blog_links}
        ...
        <div class="footer-bottom">
            <p>© 2026 Himu — Vedic Astrologer &amp; Tarot Reader, Online for Canada</p>
...
def services_section():
    ...
    <div class="container">
        ...
        <p class="section-subtitle">The complete offering, delivered online for clients anywhere in Canada</p>
...
def why_section():
    ...
    <div class="container">
        ...
        <div class="why-grid">
            ...
            <div class="why-card">
                <div class="icon icon-home"><svg viewBox="0 0 40 40" aria-hidden="true"><path d="M8 19 20 9l12 10" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"/><path d="M11 17v13h18V17" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linejoin="round"/><path d="M17 30v-7h6v7" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linejoin="round"/></svg></div>
                <h3>Available Anywhere in Canada</h3>
                <p>Online consultations available to clients across Canada — all you need is WhatsApp.</p>
            </div>
        </div>
    </div>
</section>
...
def process_section():
    ...
    <div class="container">
        ...
        <p class="section-subtitle">Booking a reading from Canada is simple — here's what to expect</p>
        <div class="process-grid">
            ...
            <div class="step-card">
                ...
                <p>Himu prepares your chart or draws your spread and walks you through it on a WhatsApp voice/video call, at a time that suits your local Canadian time zone.</p>
            </div>
            <div class="step-card">
...
{cards}
    ...
    <div class="container">
        <div class="locations-intro">
            <h2 class="section-title">Best Astrologer — Cities in Canada</h2>
            <p class="section-subtitle">Find your city below for online astrology &amp; tarot guidance, available anywhere in Canada</p>
        </div>
...
def pricing_section():
    ...
    <div class="container">
        ...
        <p class="section-subtitle">Starting prices in CAD — final fee confirmed on WhatsApp based on your exact requirement</p>
        <div class="pricing-grid">
            <div class="price-card">
                <h3>Quick Clarity</h3>
                <span class="price-sub">Tarot Reading</span>
                <div class="price-amount">C$25<span>starting</span></div>
            ...
            <div class="price-card popular">
                ...
                <div class="price-amount">C$49<span>starting</span></div>
            ...
            <div class="price-card">
                ...
                <div class="price-amount">C$99<span>starting</span></div>
...
def cta_section():
    ...
    <div class="container">
        <h2>Ready to get clarity, wherever you are in Canada?</h2>
        <p>Book an online tarot or astrology session today — evening and weekend slots available across Canadian time zones.</p>
        ...
        <p class="cta-note">Evening &amp; weekend slots available | Sessions scheduled across Canadian time zones</p>
    </div>
</section>
'''
...
def local_business_schema(name, description, area_served_json, url):
    return (
        ...
        f'"telephone": "{PHONE}", "email": "{EMAIL}", "url": "{url}", "priceRange": "CAD", '
...
def build_homepage():
    title = clip("Best Astrologer for Canada | Vedic Astrology, Tarot &amp; Vastu – Himu", 60)
    desc = clip("Himu is a certified Vedic astrologer &amp; tarot reader offering online consultations "
                "for clients across Canada via WhatsApp/video call. Astrology, Numerology &amp; Vastu.", 160)
    canonical = f"{SITE_BASE}/index.html"
    schema1 = local_business_schema(
        "Himu Astrology — Best Astrologer for Clients in Canada",
        "Certified Vedic Astrologer, Tarot Reader, Numerologist and Vastu Consultant, Himu, offering online consultations for clients across Canada.",
        '{"@type": "Country", "name": "Canada"}',
        canonical,
    )
    schema2 = ('{"@context": "https://schema.org", "@type": "FAQPage", "mainEntity": ['
               '{"@type": "Question", "name": "Does Himu offer astrology consultations in Canada?", '
               '"acceptedAnswer": {"@type": "Answer", "text": "Yes. Himu is a certified Vedic astrologer and tarot reader offering online consultations to clients across Canada over WhatsApp voice or video call, for love, career, marriage, finance and family matters."}}, '
               '{"@type": "Question", "name": "How do I book a session from Canada?", '
               '"acceptedAnswer": {"@type": "Answer", "text": "Message Himu on WhatsApp with your name, date of birth (and time/place of birth for a Vedic astrology reading), and the city you\'re writing from. Available slots and fees will be shared, and the session is conducted over WhatsApp voice or video call at a convenient time in your local Canadian time zone."}}, '
               '{"@type": "Question", "name": "Which US cities are served?", '
               '"acceptedAnswer": {"@type": "Answer", "text": "Clients from any city in Canada can book online \u2014 from Toronto and Vancouver to smaller towns \u2014 since every session is conducted remotely over WhatsApp or video call."}}, '
               ...
               '"acceptedAnswer": {"@type": "Answer", "text": "Starting prices are listed in Canadian Dollars (CAD). Fees vary by session type and duration \u2014 message Himu on WhatsApp with what you need and the exact price will be confirmed before you book."}}]}')
    ...
    <div class="container hero-container">
        <div class="hero-content">
            <div class="hero-badge">Online Consultations for Clients Across Canada</div>
            <h1>Best Astrologer for <span class="highlight">Canada</span><br>Vedic Astrology, Tarot &amp; Vastu — Online</h1>
            <p>Himu — certified Vedic astrologer &amp; tarot reader, offering online consultations for clients across Canada. Accurate predictions for love, career, marriage, finance and life purpose, delivered over WhatsApp at a time that suits your local time zone.</p>
            ...
            <div class="keywords">
                <span>Best Astrologer in Canada</span>
                <span>Online Astrologer Canada</span>
                <span>Tarot Reader Canada</span>
                <span>Vastu Consultant Canada</span>
            </div>
        </div>
    ...
    <div class="container">
        ...
        <div class="faq-list">
            <details class="faq-item">
                <summary>Does Himu offer astrology consultations in Canada?</summary>
                <p>Yes. Himu is a certified Vedic astrologer and tarot reader offering online consultations to clients across Canada over WhatsApp voice or video call, for love, career, marriage, finance and family matters.</p>
            </details>
            <details class="faq-item">
                <summary>How do I book a session from Canada?</summary>
                <p>Message Himu on WhatsApp with your name, date of birth (and time/place of birth for a Vedic astrology reading), and the city you're writing from. Available slots and fees will be shared, and the session is conducted over WhatsApp voice or video call at a time that suits your local Canadian time zone.</p>
            </details>
            <details class="faq-item">
                <summary>Which US cities are served?</summary>
                <p>Clients from any city in Canada can book online — from Toronto and Vancouver to smaller towns — since every session is conducted remotely over WhatsApp or video call.</p>
            </details>
            <details class="faq-item">
            ...
            <details class="faq-item">
                ...
                <p>Starting prices are listed in Canadian Dollars (CAD). Fees vary by session type and duration — message Himu on WhatsApp with what you need and the exact price will be confirmed before you book.</p>
            </details>
        </div>
    </div>
</section>
...
def build_city_page(c):
    ...
    schema1 = local_business_schema(
        ...
        f"Vedic astrology, tarot reading, numerology and Vastu consultation, delivered online to clients in {name}, {nation}, Canada.",
    ...
    schema2 = ('{"@context": "https://schema.org", "@type": "FAQPage", "mainEntity": ['
               ...
               '"acceptedAnswer": {"@type": "Answer", "text": "Starting prices are listed in Canadian Dollars (CAD) on the pricing section of the site. Message Himu on WhatsApp with your requirement and the exact fee and available slots will be shared."}}]}')
    ...
    <div class="container">
        ...
        <div class="faq-list">
            ...
            <details class="faq-item">
                ...
                <p>Starting prices are listed in Canadian Dollars (CAD) above. Message Himu on WhatsApp with your requirement and the exact fee and available slots will be shared.</p>
            </details>
        </div>
    </div>
</section>
...
def build_blog_index():
    title = clip("Astrology &amp; Tarot Blog | Vedic Astrology Guides for Canada – Himu", 60)
    desc = clip("Free guides on Vedic astrology, tarot, numerology and Vastu from Himu — "
                "practical reading for clients across Canada.", 160)
...
<header class="hero loc-hero">
    <div class="container">
        ...
        <p>Practical, plain-English guides to Vedic astrology, tarot, numerology and Vastu — for readers across Canada.</p>
    </div>
</header>
...
{render_post_body(post["body"])}
        ...
        <div class="cta" style="margin: 40px 0; padding: 40px 28px;">
            ...
            <p>Book a session with Himu — online, over WhatsApp, for clients anywhere in Canada.</p>
            <div class="cta-buttons">
        ...
        <div class="local-fact-card" style="margin-top:40px;">
            <h3>About Himu</h3>
            <p style="font-size:0.94rem;">Himu is a certified astrologer offering tarot, Vedic astrology, numerology and Vastu consultation online, for clients across Canada.</p>
        </div>
    </div>
</article>
